...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    console.error('Error en ReportsErrorBoundary:', error, errorInfo);
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="text-center">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-4">
                  Error en los Reportes
                </h1>
                
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                  Ha ocurrido un error inesperado al cargar los reportes. 
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    ...
                    className="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                  >
