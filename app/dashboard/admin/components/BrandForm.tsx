...
export default function BrandForm({ brand, onSuccess, onCancel }: BrandFormProps) {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    try {
      if (isEditMode) {
        // Agregar el ID de la marca para actualización
    ...
    <form action={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ej: Coca Cola, Pepsi, Nestlé..."
        />
      ...
      <p className="text-xs text-gray-500 text-center">
        ...
        {isEditMode 
          ? 'Los productos asociados mantendrán su vinculación con esta marca.'
          : 'La marca estará disponible inmediatamente para asociar con productos.'
        }
      </p>
    </form>
  );
